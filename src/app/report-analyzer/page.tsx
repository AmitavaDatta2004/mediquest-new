    ...
    <main className="min-h-screen bg-gradient-to-b from-background to-muted">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 md:mt-20 text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 sm:text-5xl mb-4 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
            Medical Report Analyzer
          </h1>
          <p className="mt-3 text-lg md:text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
        ...
        <div className="py-16 border-t border-gray-100 dark:border-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="relative p-6 bg-white dark:bg-card rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-800"
              >
